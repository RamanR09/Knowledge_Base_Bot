...
const SIDE_CLASSES: Record<"top" | "right" | "bottom" | "left", string> = {
  right:
    "inset-y-0 right-0 h-full w-full border-l sm:max-w-md data-open:slide-in-from-right data-closed:slide-out-to-right",
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/10 outline-none data-open:animate-in data-closed:animate-out data-open:duration-300 data-closed:duration-200 motion-reduce:animate-none",
          SIDE_CLASSES[side],
          className
        )}
        {...props}
